...
class MechanicCoverageTests(unittest.TestCase):
    ...
    def test_current_coverage_reflects_qualified_pipelines(self):
        ...
        self.assertEqual(report.implemented_groups, 14)
        self.assertEqual(report.occurrence_coverage_percent, 20.99)
        self.assertEqual(report.club_coverage_percent, 34.09)
        self.assertEqual(report.unclassified_groups, 111)
