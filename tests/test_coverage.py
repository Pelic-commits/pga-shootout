...
class MechanicCoverageTests(unittest.TestCase):
    ...
    def test_current_coverage_reflects_qualified_pipelines(self):
        ...
        self.assertEqual(report.implemented_groups, 30)
        self.assertEqual(report.occurrence_coverage_percent, 31.48)
        self.assertEqual(report.club_coverage_percent, 39.77)
        self.assertEqual(report.unclassified_groups, 95)
