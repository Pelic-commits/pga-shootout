...
class MechanicCoverageTests(unittest.TestCase):
    ...
    def test_current_coverage_reflects_qualified_pipelines(self):
        ...
        self.assertEqual(report.implemented_groups, 28)
        self.assertEqual(report.occurrence_coverage_percent, 29.63)
        self.assertEqual(report.club_coverage_percent, 38.64)
        self.assertEqual(report.unclassified_groups, 97)
