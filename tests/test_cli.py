...
class CliTests(unittest.TestCase):
    ...
    def test_user_gaps_cli_regenerates_inventory_report(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(result, 0)
            self.assertIn('"inventory_clubs": 21', output.getvalue())
    ...
    def test_inventory_status_cli_human_json_and_reports_share_one_audit(self):
        ...
        with contextlib.redirect_stdout(human_output):
            result = main(common)
        self.assertEqual(result, 0)
        self.assertIn("Engine coverage: ", human_output.getvalue())
        ...
        self.assertEqual(payload["inventory_clubs"], len(payload["clubs"]))
        self.assertEqual(payload["global_clubs"], 88)
